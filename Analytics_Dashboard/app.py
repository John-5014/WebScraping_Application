...
def predict_laptop_price():
    ...
    st.subheader("Fill the entries for Prediction")
    ...
    if st.button('Predict Price'):
        ...
        st.title("The predicted price for this laptop is Ksh " + str(int(np.exp(pipe.predict(query)[0]))))

# Call the function to display the page in Streamlit
